...
Tests:  
	&emsp;In the first N signals to HUB the sequence  
		&emsp;&emsp;Does the sequence have any repeated actors or is each listed once?  
	&emsp;Is the sequence preserved over time?  
	&emsp;Actor Counts, each Actor has a count of the number of times it has signaled,  
		&emsp;&emsp;over a long time, how close are these numbers.  
